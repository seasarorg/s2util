...
public class FieldDescImplTest {
    ...
    public void testHOGE() throws Exception {
        ...
        FieldDesc hoge = beanDesc.getFieldDesc("HOGE");
        ...
        ParameterizedClassDesc parameterizedClassDesc =
            hoge.getParameterizedClassDesc();
        assertThat(parameterizedClassDesc, is(notNullValue()));
        assertThat(
            hoge.getParameterizedClassDesc().isParameterizedClass(),
            is(not(true)));
    ...
    public void testAaa() throws Exception {
        BeanDesc beanDesc = new BeanDescImpl(MyBean.class);
        FieldDesc aaa = beanDesc.getFieldDesc("aaa");
        ...
        ParameterizedClassDesc parameterizedClassDesc =
            aaa.getParameterizedClassDesc();
        assertThat(parameterizedClassDesc, is(notNullValue()));
        assertThat(parameterizedClassDesc.isParameterizedClass(), is(true));
        assertThat(
            parameterizedClassDesc.getRawClass(),
    ...
    public void testList() throws Exception {
        BeanDesc beanDesc = new BeanDescImpl(MyBean.class);
        FieldDesc hoge = beanDesc.getFieldDesc("list");
        assertThat(
            hoge.getElementClassOfCollection(),
    ...
    public void testMap() throws Exception {
        BeanDesc beanDesc = new BeanDescImpl(MyBean.class);
        FieldDesc hoge = beanDesc.getFieldDesc("map");
