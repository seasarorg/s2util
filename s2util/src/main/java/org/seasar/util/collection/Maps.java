...
public class Maps<K, V> {
    ...
    public static <KEY, VALUE> Maps<KEY, VALUE> concurrentHashMap(
        ...
        return new Maps<KEY, VALUE>(new ConcurrentHashMap<KEY, VALUE>()).$(
            key,
            value);
    }
    ...
    public static <KEY, VALUE> Maps<KEY, VALUE> identityHashMap(final KEY key,
            final VALUE value) {
        return new Maps<KEY, VALUE>(new IdentityHashMap<KEY, VALUE>()).$(
            key,
            value);
    }
    ...
    public static <KEY, VALUE> Maps<KEY, VALUE> linkedHashMap(final KEY key,
            final VALUE value) {
        return new Maps<KEY, VALUE>(new LinkedHashMap<KEY, VALUE>()).$(
            key,
            value);
    }
